...
- (id)initWithFrame:(CGRect)frame  //只有  alloc  init  和添加到视图   具体的细节操作不在这里面设置
{
...
#warning  由于来源label在x方向上面依赖于时间label,所以具体的frame的设置也剥离出来了
    // 4.来源
    self.sourceLabel.text = status.source;
    self.sourceLabel.textColor = [UIColor lightGrayColor];
    self.sourceLabel.font = HMStatusOrginalSourceFont;
    ...
    // 6.配图相册  //自定义的frame里面有这个frame  yyyy
